				...
				<div class="box-body">
					<div class="form-group">
						<label for="exampleInputEmail1">회원번호</label> <input type="text"
							name="mno" class="form-control"
							value="${center.mno}" readonly="readonly">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">제목</label> 
						<input type="text" name='cttitle' class="form-control" 
						value="${center.cttitle}" readonly="readonly">
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">문의내용</label>
						<textarea class="form-control" name="ctcontent" rows="12"
							readonly="readonly" maxlength="500">${center.ctcontent}</textarea>
					</div>
				</div>
				<!-- /.box-body -->
