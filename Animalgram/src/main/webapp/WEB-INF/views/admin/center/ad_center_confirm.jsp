							...
							<div class="box box-success">
								...
								<div class="box-body">
									<div class="form-group">
										<label for="exampleInputEmail1">답변 제목</label>
										<input class="form-control" type="text" name="ctrtitle" autofocus="autofocus" maxlength="33">
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">답변 내용</label>
										<textarea class="form-control" name="ctrcontent" rows="12" maxlength="500"></textarea>
									</div>
								</div>
								<!-- /.box-body -->
