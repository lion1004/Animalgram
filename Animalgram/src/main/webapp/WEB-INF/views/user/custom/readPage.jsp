		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" action="modifyPage" method="post">
					...
					<input type='hidden' name='cuno' value="${customVO.cuno}"> <input
...
$(document).ready(function(){
	...
	$("#modifyBtn").on("click", function(){
		formObj.attr("action", "/user/custom/modifyPage");
...
/* 	$("#removeBtn").on("click", function(){
	...
	$("#removeBtn").on("click", function(){
		...
		formObj.attr("action", "/user/custom/removePage");
		formObj.submit();
	});	
	
	$("#goListBtn ").on("click", function(){
		formObj.attr("method", "get");
		formObj.attr("action", "/user/custom/seller_list");
		formObj.submit();
	});
