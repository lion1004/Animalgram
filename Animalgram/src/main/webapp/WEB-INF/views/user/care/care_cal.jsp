...
var init = (function(){
	...
	var date = '${groupVO.gdate}';
	var title = '${groupVO.gtitle}';
	var type = '${groupVO.gtype}';
	var cano = '${groupVO.gno}';
		...
		for(var k = 0; k < 7; k++){
			...
			if(config.Day() > k && l == 0){
				...
				if(config.Month() == nowday.month && input == nowday.day){
					...
					linkGno = inputspecCano[deinput];
					var str1 = "<input type='hidden' value='<hr><h3>담당 전문가</h3><hr>"+inputspecText[deinput];
					var str2 = "<br><br><hr><h3>훈련내용</h3><hr>"+inputspecType[deinput]+"<br><br>' class='spt'/>";
					table += "<div id='special'>"+input+str1+str2+"</div>";
					deinput++;
...
var eventList = {
	...
	handelClick : function(e){
		 ...
		 if(spt == null){
			 ...
			 var str = "<br><br><br><a href='/group/info?gno="+linkGno+"'class='btn btn-primary'>✿훈련 참여하기✿</a>";
			 spt = spt.value;
			 print = e.target.innerHTML+"일<br>"+spt+str;
		 }
		if(daywrite == null){
			return false;
		}else{
...
<div class="row">
     <div class="col-lg-12" style="background: #ff8080;">
          <h1 class="page-header" style="color: #ffffff">반려동물 행동화 훈련 신청
             <small style="color: #222222">・゜゜・**・゜|*╹ω╹*|゜・**・゜゜・*</small>
          </h1>
     </div>
</div>
<br>
  	<div class="container">
		<div class="row">
            <div class="col-md-4">
                <img class="img-responsive img-rounded" src="/resources/image/group/catdog.jpg" alt="">
            </div>
            <!-- /.col-md-8 -->
            <div class="col-md-6">
                ...
                <p>확실한 전문가가 함께 합니다。</p>
                <p>･ﾟﾟ･*:.｡..｡.:*ﾟ:*:✼✿(ღ✪ｖ✪)｡ﾟ:*:✼.｡✿.｡  </p>
                <a class="btn btn-primary btn-lg" href="#pro">✿전문가 보기 ✿</a>
            </div>
            <!-- /.col-md-4 -->
   		</div>
   </div>
