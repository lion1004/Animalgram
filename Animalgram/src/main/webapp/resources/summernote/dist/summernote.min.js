/*! Summernote v0.8.4 | (c) 2013- Alan Hong and other contributors | MIT license */ ! function(a) {
    ...
    "use strict";
    var isSupportAmd = "function" == typeof define && define.amd,
    ...
    $.fn.extend({
        summernote: function() {
            ...
            d = $.extend({}, $.summernote.options, d), d.langInfo = $.extend(!0, {}, $.summernote.lang["en-US"], $.summernote.lang[d.lang]), d.icons = $.extend(!0, {}, $.summernote.options.icons, d.icons), d.tooltip = "auto" === d.tooltip ? !agent.isSupportTouch : d.tooltip, this.each(function(a, b) {
                var c = $(b);
            ...
            this.fontSize = function(a) {
                ...
                if (a) {
                    var b = list.find(list.from(a.childNodes), dom.isText),
                        c = b.nodeValue.indexOf(dom.ZERO_WIDTH_NBSP_CHAR); - 1 !== c && b.deleteData(c, 1), dom.isEmpty(a) && dom.remove(a), e.removeData("bogus")
                }
                ...
                return b.length && (c.isNewWindow = "_blank" === b.attr("target")), c
        ...
        Clipboard = function(a) {
            ...
            this.events = {
                ...
                if (dom.isImg(b) && 0 === c.indexOf("data:")) {
                    for (var d = atob(b.src.split(",")[1]), e = new Uint8Array(d.length), f = 0; f < d.length; f++) e[f] = d.charCodeAt(f);
                    var g = new Blob([e], {
                        type: "image/png"
                    });
    ...
    var Codeview = function(a) {
        ...
        Fullscreen = function(a) {
            ...
            this.resizeTo = function(a) {
                ...
                c.toggleClass("fullscreen"), this.isFullscreen() ? (e.data("orgHeight", e.css("height")), g.on("resize", this.onResize).trigger("resize"), h.css("overflow", "hidden")) : (g.off("resize", this.onResize), this.resizeTo({
                    h: e.data("orgHeight")
                }), h.css("overflow", "visible")), a.invoke("toolbar.updateFullscreen", this.isFullscreen())
                ...
                this.$handle = $(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', e.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', e.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(d), this.$handle.on("mousedown", function(d) {
                    if (dom.isControlSizing(d.target)) {
                        ...
                        c.on("mousemove", h).one("mouseup", function(b) {
                            b.preventDefault(), c.off("mousemove", h), a.invoke("editor.afterCommand")
                ...
                return $.Deferred(function(e) {
                    ...
                    c.onDialogShown(b.$dialog, function() {
                        ...
                        g.on("input", j).on("paste", function() {
                            setTimeout(j, 0)
                        }).val(d.url).trigger("focus"), b.toggleLinkBtn(h, f, g), b.bindEnterKey(g, h), b.bindEnterKey(f, h);
                        var k = void 0 !== d.isNewWindow ? d.isNewWindow : a.options.linkTargetBlank;
                        i.prop("checked", k), h.one("click", function(a) {
        ...
        VideoDialog = function(a) {
            ...
            this.initialize = function() {
                ...
                var b, c = a.match(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/),
                    ...
                    f = a.match(/\/\/(player\.)?vimeo\.com\/([a-z]*\/)*(\d+)[?]?.*/),
        ...
        HelpDialog = function(a) {
            ...
            this.createShortCutList = function() {
                ...
                var a = e.dialogsInBody ? $(document.body) : d,
                    b = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.4</a> · ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                this.$dialog = c.dialog({
        ...
        HintPopover = function(a) {
            ...
            this.events = {
                ...
                if (b.length) {
                    ...
                    this.lastWordRange.insertNode(c), range.createFromNode(c).collapse().select(), this.lastWordRange = null, this.hide(), a.triggerEvent("change", a.layoutInfo.editable.html(), a.layoutInfo.editable), a.invoke("editor.focus")
                }
